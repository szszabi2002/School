...
$idk = $_GET['id'];
$SQL= "SELECT * FROM adatok WHERE id='$idk'";
...
<div class="grid-container">
  ...
  <img class="card-img-top" src="kepek/adatok/thumb/<?= $sor["thumbnail"] ?>?<?=rand(1,32000)?>"  alt="Card image cap">
  <div class="card-body">
    ...
    <?php endif; ?>
    <a href="index.php"> <button type="button" class="btn btn-dark w-100" >Vissza az elöző oldalra</button></a>
  </div>
</div>
</div>
<?php endforeach;?>
