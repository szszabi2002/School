    ...
    <main>
        ...
        <?php foreach ($adatok as $sor): ?>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-3">
                <div class="card">
                    <img class="card-img-top img-fluid rounded" src="Forras/kepek/helyszinek/<?= $sor[
                        'varos'
                    ] ?>.jpg" alt="' <?= $sor['varos'] ?>">
                    <div class="card-body text-center">
                        <h5 class="card-title"><?= $sor['varos'] ?></h5>
                        <a href="megtekint.php?id='<?= $sor[
                            'id'
                        ] ?>'" class="card-link bi-eye"></a>
                        <a href="modosit.php?id='<?= $sor[
                            'id'
                        ] ?>'" class="card-link bi-pencil"></a>
                        <a href="torol.php?id='<?= $sor[
                            'id'
                        ] ?>'" class="card-link bi-trash"></a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
