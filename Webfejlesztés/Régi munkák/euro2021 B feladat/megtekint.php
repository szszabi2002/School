                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-1 mb-3">
                    <div class="card">
                        <img class="card-img-top img-fluid rounded"
                            src="Forras/kepek/stadionok/<?= $sor['varos']; ?>.jpg" alt="' <?= $sor['varos']; ?>">
                        <div class="card-body text-center">
                            <h5 class="card-title"><?= $sor['varos']; ?></h5>
                            <b id="nagybetu" class="card-title"><?= $sor['nev']; ?></b>
                            <p class="card-text text-justify"><b>Férőhelyek száma:</b> <?= $sor['ferohelyek']; ?> fő</p>
